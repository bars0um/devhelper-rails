...
while True:
    ...
    if datastore.next_step == states.UNINITIALIZED and datastore.project_description == "":
    ...
    if len(datastore.queue) > 0:
        ...
        if "%appname" in user_message:
            ...
            datastore.next_step = states.UNINITIALIZED
        ...
        # assumption: project.md contains the project description...must update to make this obvious to user
            ...
            if datastore.next_step != states.COMPLETED_FIRST_ROUND:
            ...
            datastore.next_step = states.COMPLETED_ANALYSIS
        ...
        # also ability to add file to app_files
            ...
            if datastore.next_step != states.COMPLETED_ANALYSIS:
